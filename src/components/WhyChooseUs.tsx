        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Why Choose OLoughlin Construction & Shopfitting?
            </h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              We deliver high-quality construction and shopfitting services with a customer-centric approach. Our experienced team ensures timely project completion and innovative solutions tailored to your needs.
            </p>
