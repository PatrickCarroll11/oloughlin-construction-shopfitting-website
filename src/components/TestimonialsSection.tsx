...
const testimonials = [
  {
    "text": "OLoughlin Construction transformed our retail space beautifully. Highly recommend!",
    "author": "Customer, Co. Meath"
  },
  {
    "text": "Professional and reliable service from start to finish.",
    "author": "Customer, Co. Kildare"
  },
  {
    "text": "Their attention to detail and craftsmanship is unmatched.",
