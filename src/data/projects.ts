...
const folderMeta: Record<string, { title: string; category: string }> = {
  "aug-2024-project-1": {
    "title": "August 2024 Project",
    "category": "Work"
  },
  "canadia-herringbone-laminate-floor-supplied": {
    "title": "Canadia Herringbone Laminate Floor Supplied",
    "category": "Work"
  },
  "new-door-supplied-and-fitted": {
    "title": "New Door Supplied And Fitted",
    "category": "Work"
  }
};
