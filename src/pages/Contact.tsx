          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                <a href="tel:0879482740" className="flex items-center gap-3 group">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">087 948 2740</p>
                  </div>
                </a>
                <a href="mailto:oloughlinbrm@gmail.com" className="flex items-center gap-3 group">
                  <div className="w-10 h-10 rounded-lg bg-brand-green-light flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                    <Mail className="h-5 w-5 text-primary group-hover:text-primary-foreground" />
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Email</p>
                    <p className="font-semibold">oloughlinbrm@gmail.com</p>
                  </div>
                </a>
